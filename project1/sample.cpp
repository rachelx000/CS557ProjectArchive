...
const char *WINDOWTITLE = "Project #1 -- Rachel Xing";
...
InitGraphics( )
{
	...
	// Sample #1: original sample program
	/*
	...
	/*
	// Sample #2: strip and ring pattern
	Pattern.Init();
	bool valid = Pattern.Create((char*)"rings.vert", (char*)"rings.frag");
	if (!valid)
		fprintf(stderr, "Could not create the Pattern shader!\n");
	else
		fprintf(stderr, "Pattern shader created!\n");
	...
	Pattern.Use();
	Pattern.SetUniformVariable((char*)"uA", 1.0f);
	Pattern.SetUniformVariable((char*)"uP", 0.25f);
	Pattern.SetUniformVariable((char*)"uTol", 0.f);
	Pattern.SetUniformVariable((char*)"uAmp", 0.f);
	Pattern.SetUniformVariable((char*)"uFreq", 10.f);
	Pattern.UnUse();
	*/

	// Sample #3: Circle Dots
	/*
	Pattern.Init();
	bool valid = Pattern.Create((char*)"circles.vert", (char*)"circles.frag");
	if (!valid)
		fprintf(stderr, "Could not create the Pattern shader!\n");
	else
		fprintf(stderr, "Pattern shader created!\n");
	...
	Pattern.Use();
	Pattern.SetUniformVariable((char*)"uDiam", 0.5f);
	Pattern.SetUniformVariable((char*)"uKa", 0.1f);
	Pattern.SetUniformVariable((char*)"uKd", 0.6f);
	Pattern.SetUniformVariable((char*)"uKs", 0.3f);
	Pattern.SetUniformVariable((char*)"uColor", 1.f, 0.5f, 0.f, 1.f);
